...
par(mfrow=c(2,2))
#pic1
with(T201202,plot((as.POSIXct(T201202[,10],"%Y/%m/%d %H:%M:%S")),T201202[,3],type="l",xlab="",ylab="Global active power"))
#pic2
with(T201202,plot((as.POSIXct(T201202[,10],"%Y/%m/%d %H:%M:%S")),T201202[,5],type="l",xlab="datatime",ylab="Voltage"))
#pic3
...
#pic4
with(T201202,plot((as.POSIXct(T201202[,10],"%Y/%m/%d %H:%M:%S")),T201202[,4],type="l",xlab="datatime",ylab="Global_reactive_power"))
dev.off()
#graphics.off()
